-- ========================================
-- SCRIPT DE CRIAÇÃO DO BANCO ARPAA
-- ========================================
-- Executar como: mysql -u root -p railway < create-schema.sql
...
--    - Básico: nome, especie, raca, sexo, idade_aproximada, porte, data_resgate, local_resgate, status, descricao, foto_url, registrado_por
--    - Saúde: vacinado, castrado, vermifugado (Enum: Sim/Não)
--    - Comportamento: temperamento, convive_criancas, convive_animais (Enum: Sim/Não)
-- 
-- 3. adotantes com critérios de adoção:
--    - Básico: id, nome, email, telefone, endereco, complemento, cidade, estado, cpf, idade
--    - Critérios: trabalha, tem_criancas, tem_pets, tem_quintal (Enum: Sim/Não)
--    - Observacoes (TEXT)
-- 
...
-- 
-- Total: 8 tabelas com todos os campos do sistema operacional
-- ========================================
